...
| [commands/](commands/) | Slash commands: `/context`, `/explore`, `/produce`, `/gate-check`, `/new-adr` |
...
| [hooks/](hooks/) | Python hooks: `mode-context.py` (per-turn reminder), `gate-check.py` (blocks code writes without approved EXP plan) |
