...
| `INFO` | No-op observation worth recording (e.g. "0 BLOCK findings, audit clean") | Note in the audit report; no further action |
...
| [/governance-audit command](../commands/governance-audit.md) | Triggers you and reports your findings to the human |
